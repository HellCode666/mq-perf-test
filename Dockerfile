...
ARG MQ_PACKAGES="./ibmmq-jre_9.2.0.0_amd64.deb ./ibmmq-runtime_9.2.0.0_amd64.deb ./ibmmq-gskit_9.2.0.0_amd64.deb ./ibmmq-server_9.2.0.0_amd64.deb ./ibmmq-java_9.2.0.0_amd64.deb ./ibmmq-samples_9.2.0.0_amd64.deb"

RUN export DEBIAN_FRONTEND=noninteractive \
  # Optional: Update the command prompt
  && echo "mq:9.2" > /etc/debian_chroot \
...
COPY --chmod=777 mq-setup.sh /home/mqm/mq-setup.sh
COPY --chmod=777 mq-start.sh /home/mqm/mq-start.sh
COPY --chmod=777 mq-setup.mqsc /home/mqm/mq-setup.mqsc

EXPOSE 1616

ENTRYPOINT ["/home/mqm/mq-setup.sh", "QMgr01", "1616", "mqexplorers"]
